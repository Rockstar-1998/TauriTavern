pub fn invoke_handler() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        super::chat_commands::get_group_chat_path,
        super::chat_commands::get_group_chat_payload_tail,
        super::chat_commands::get_group_chat_payload_before,
        super::chat_commands::save_group_chat_payload_windowed,
        super::chat_commands::patch_group_chat_payload_windowed,
        super::chat_commands::save_group_chat_from_file,
        ...
        super::workbench_commands::get_workbench_stats,
        super::workbench_commands::update_workbench_stats,
        super::workbench_commands::recreate_workbench_stats,
        ...
        super::multiplayer_commands::multiplayer_start_host,
        super::multiplayer_commands::multiplayer_stop_host,
        super::multiplayer_commands::multiplayer_join_room,
        super::multiplayer_commands::multiplayer_leave_room,
        super::multiplayer_commands::multiplayer_submit_contribution,
        super::multiplayer_commands::multiplayer_withdraw_contribution,
        super::multiplayer_commands::multiplayer_approve_join,
        super::multiplayer_commands::multiplayer_broadcast_event,
        super::player_persona_commands::list_player_personas,
        super::player_persona_commands::get_player_persona,
        super::player_persona_commands::save_player_persona,
        super::player_persona_commands::delete_player_persona,
        super::player_persona_commands::read_player_persona_avatar_asset,
        // File commands
        ...
        super::file_commands::stage_frontend_file,
        super::file_commands::cleanup_frontend_file,
        super::file_commands::save_export_file,
        super::generation_trace_commands::save_generation_trace,
        super::debug_commands::log_frontend_event,
        super::generation_binding_commands::resolve_generation_bindings,
        // Avatar commands
        ...
        super::renderer_commands::list_renderer_packages,
        super::renderer_commands::import_renderer_package,
        super::renderer_commands::delete_renderer_package,
        ...
        // Generation prepare commands
        super::generation_prepare_commands::prepare_generation,
        super::display_projection_commands::project_chat_display,
        // Tokenizer commands
        ...
        super::bridge::get_startup_status,
